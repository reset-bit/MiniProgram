...
Page({
  ...
  onLoad: function(options) {
    ...
    var restaurant = wx.getStorageSync('restaurant')[0].title;
    var hotel = wx.getStorageSync('hotel')[0].title;
  ...
  createPlan:function(){
    ...
    plan.restaurant = this.data.restaurant;
    plan.hotel = this.data.hotel;
